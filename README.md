...
```shell
$ # Run test db container
(djangotest-tips)$ docker run -d --rm --name test-django-db -p 5433:5432 -e POSTGRES_DB=test_django -e POSTGRES_USER=django -e POSTGRES_PASSWORD=django postgres:13.2

$ # Run test cases
(djangotest-tips)$ pytest
```
